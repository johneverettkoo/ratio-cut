...
such that there is an edge between vertices 3 and 4 of weight $\epsilon$ (for 
...
$f_\epsilon = \begin{bmatrix} 1/2 & 1/2 & -1/2 & -1/2 \end{bmatrix}^\top$, so
$\lim\limits_{\epsilon \to 0} v_2(L_\epsilon) = f_\epsilon$.
