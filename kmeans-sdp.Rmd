...
The RatioCut-SDP solution (Lee and Strohmer)[^rcsdp] yields:
...
used Lloyd's algorithm to find a clustering. Lee and Strohmer are not 
clear on how this should be handled, and neither are Peng and Wei. 
2. Lee and Strohmer provide some criteria under which RatioCut-SDP is 
